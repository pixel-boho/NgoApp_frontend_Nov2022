...
class ViewAllDonorsScreen extends StatefulWidget {
  final fundraiserIdReceived;

  ViewAllDonorsScreen(this.fundraiserIdReceived);

  @override
  _ViewAllDonorsScreenState createState() => _ViewAllDonorsScreenState();
}

class _ViewAllDonorsScreenState extends State<ViewAllDonorsScreen>
  ...
  void initState() {
    ...
    _participantsBloc.getAllPersonDetails(
        false, widget.fundraiserIdReceived, true);
  }
    ...
    if (_itemsScrollController.offset >=
      ...
      if (_participantsBloc.hasNextPage) {
        Future.delayed(const Duration(milliseconds: 1000), () {
          _participantsBloc.getAllPersonDetails(
              true, widget.fundraiserIdReceived, true);
        });
      }
    }
    if (_itemsScrollController.offset <=
