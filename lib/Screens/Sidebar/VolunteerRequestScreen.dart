...
class VolunteerRequestScreen extends StatefulWidget {
  @override
  _VolunteerRequestScreenState createState() => _VolunteerRequestScreenState();
}
...
class _VolunteerRequestScreenState extends State<VolunteerRequestScreen> {
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: Image(
                            image: AssetImage(
                                'assets/images/ic_volunteer_with_us.png'),
  ...
  void _submitFunction() {
    ...
    bodyParams["address"] = _address.trim();

    CommonWidgets().showNetworkProcessingDialog();
    _commonBloc.createVolunteer(json.encode(bodyParams)).then((value) {
      Get.back();
