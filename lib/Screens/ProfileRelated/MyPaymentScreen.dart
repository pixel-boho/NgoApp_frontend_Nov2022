...
import 'package:ngo_app/Screens/ProfileRelated/Fragments/DonationHistory.dart';
...
class _MyPaymentHistoryState extends State<MyPaymentHistory>
  ...
  infoTabs() {
    return TabBar(
      ...
      tabs: [
        Tab(
          child: tabItem(context, 'Fundraiser Transactions'),
        ),
        Tab(
          child: tabItem(context, 'Donation Transactions'),
        ),
      ],
