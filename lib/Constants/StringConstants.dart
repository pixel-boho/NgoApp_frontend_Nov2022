class StringConstants {
  ...
  ''' What do you do when you see something or someone who needs a change in
life? Perhaps you think about it for a while and probably start looking for ways to
help those in need. But you simply need to figure out where to start. We've been
there too. And with that thought Crowd Works India Foundation was born.
One-third of deaths around the world, around 18 million people a year or 50,000
per day are due to poverty-related causes. Among people in developing nations,
women and children are affected by severe poverty. Our focus is on their
well-being and rights in marginalized communities. We emphasize promoting
quality healthcare, comprehensive education, better living conditions, and
disaster preparedness and relief measures.
A large number of people show a lack of enthusiasm for making donations. We
set out to find out why. The reason was quite simple. It wasn't that people were not
willing to help, they were just unsure whether their donations are going to the right
people - the ones who needed it the most. We serve people by providing a
trustworthy and legitimate platform to donate money to the needy people of
society. Our overall goal is on alleviating poverty and social injustice. ''';

  static const String visionInfo = '''
 We aim to find a voice, show our unique work, and create a world where
...
Our mission is to make fundraising easier, by keeping the entire process easy and
legitimate. To make an impact on society we have adopted the following mission
objective.
 To work relentlessly for providing quality health care and medical services
for the deprived.
 To help communities affected by disasters and emergencies like floods,
cyclones, earthquakes, etc.
 To prevent fake charity approaches that take advantage of emergency
situations.
 To attract volunteers who are passionate about helping the indigent
irrespective of any profit and gain.
To transform rural communities into better living conditions.''';
