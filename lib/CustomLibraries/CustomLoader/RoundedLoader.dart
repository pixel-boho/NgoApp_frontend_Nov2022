...
class RoundedLoader extends StatefulWidget {
  ...
  RoundedLoader({this.color1 = Colors.deepOrangeAccent, this.color2 = Colors.yellow, this.color3 = Colors.lightGreen});

  @override
  _RoundedLoaderState createState() => _RoundedLoaderState();
}

class _RoundedLoaderState extends State<RoundedLoader> with TickerProviderStateMixin {
