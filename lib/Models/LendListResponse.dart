class LendListResponse {
  int _statusCode;
  String _baseUrl;
  List<LendListItem> _list;
  int _page;
  int _perPage;
  bool _hasNextPage;
  int _totalCount;
  ...
  List<LendListItem> get list => _list;

  set list(List<LendListItem> list) => _list = list;
  ...
  LendListResponse.fromJson(Map<String, dynamic> json) {
    _statusCode = json['statusCode'];
    _baseUrl = json['baseUrl'];
    if (json['list'] != null) {
      _list = [];
      json['list'].forEach((v) {
        _list.add(new LendListItem.fromJson(v));
      });
    }
    _page = json['page'];
...
class LendListItem {
  ...
  LendListItem.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    _title = json['title'];
